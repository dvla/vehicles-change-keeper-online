...
libraryDependencies ++= Seq(
  cache,
  filters,
  "dvla" %% "vehicles-presentation-common" % "2.20.1-SNAPSHOT" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.20.1-SNAPSHOT" classifier "tests" withSources() withJavadoc() exclude("junit", "junit-dep"),
