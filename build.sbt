...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.8" classifier "tests" withSources() withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehicleAndKeeperLookupProject = vehicleAndKeeperLookup("0.3").disablePlugins(PlayScala, SassPlugin, SbtWeb)
