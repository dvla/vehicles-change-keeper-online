...
import uk.gov.dvla.vehicles.sandbox.ProjectDefinitions.vehiclesLookup
...
libraryDependencies ++= Seq(
  cache,
  filters,
  "dvla" %% "vehicles-presentation-common" % "2.6.1-SNAPSHOT" withSources() withJavadoc() exclude("junit", "junit-dep"),
