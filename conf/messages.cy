...
change_keeper_completeandconfirm.dateofsale.disposalDate.warning = Our records show you became the keeper of this vehicle on {0} which is shown on your V5C registration certificate (logbook). As the date of sale you’ve entered is before this, please enter a correct date and select ‘Next’ to continue.
change_keeper_completeandconfirm.dateofsale.keeperChangeDate.warning = Our records show you became the keeper of this vehicle on {0} which is shown on your V5C registration certificate (logbook). As the date of sale you’ve entered is before this, please enter a correct date and select ‘Next’ to continue.
