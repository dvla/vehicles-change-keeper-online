...
change_keeper_completeandconfirm.dateofsale.warning = Our records show you became the keeper of this vehicle on {0} which is shown on your V5C registration certificate (logbook). As the date of sale you’ve entered is before this, please enter a correct date and select ‘Next’ to continue.
change_keeper_completeandconfirm.dateofsale.warning.over12Months = Mae’r dyddiad yr ydych wedi’i rhoi dros 12 mis yn ôl, a wnewch chi wirio’r dyddiad a sicrhau ei fod yn gywir os gwelwch yn dda.
